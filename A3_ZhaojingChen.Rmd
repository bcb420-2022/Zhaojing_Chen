...
GSEAResults <- read.table(file = file.path(getwd(),"data", "gsea_report_for_na_pos_1649710076185.tsv"), sep = "\t", header = TRUE, stringsAsFactors = FALSE, check.names = FALSE, fill = TRUE)
...
GSEAResults <- read.table(file = file.path(getwd(),"data", "gsea_report_for_na_neg_1649710076185.tsv"), sep = "\t", header = TRUE, stringsAsFactors = FALSE, check.names = FALSE, fill = TRUE)
knitr::kable(data.frame(GSEAResults[1:5, c(1, 4:8)]), format = "html", digits = 5)
```
...
#path to my image 
output_network_file <- file.path(getwd(),"images","initial_screenshot_network.png")
...
cluster1em_annot_png_file_name <- file.path(getwd(),"images","cluster1em_autoannot.png")
...
cluster1em_clean_annot_png_file_name <- file.path(getwd(),"images","cluster_clean_autoannotated.png")
...
tf_annot_png_file_name <- file.path(getwd(),"images","with_tf.png")
...
tf_collaps_annot_png_file_name <- file.path(getwd(),"images","tf_collapsed.png")
...
```{r eval=TRUE,echo=FALSE}
rank_pathway_png_file_name <- file.path(getwd(),"images","DNAdamageresponse_rank.png")
...
rank_pathway_png_file_name <- file.path(getwd(),"images","DNAdamage_logf.png")
htmltools::img(src = knitr::image_uri(rank_pathway_png_file_name), 
...
```{r eval=TRUE}
#load the rank file
ranks <- read.table(file.path(getwd(),"data","rank_final.rnk"), header = TRUE, sep = "\t", quote="\"", 
...
enr_file1 <- read.table(file = file.path(getwd(),"data", "gsea_report_for_na_pos_1649710076185.tsv"), sep = "\t",quote="\"", header = TRUE, stringsAsFactors = FALSE, check.names = FALSE, fill = TRUE,row.names = 1)
# na_pos file
enr_file2 <- read.table(file = file.path(getwd(),"data", "gsea_report_for_na_neg_1649710076185.tsv"), sep = "\t",quote="\"", header = TRUE, stringsAsFactors = FALSE, check.names = FALSE, fill = TRUE,row.names = 1)
