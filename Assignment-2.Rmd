...
# Run a t test
#t.test(x=t(gr_etoh_samples),y=t(gr_dex_samples))
...
```{r,fig.cap='Figure 5:unclustered heatmap for significant differential expression with row normalization',eval=FALSE}
top_hits <- output_hits$ensembl_gene_id[
